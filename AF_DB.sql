...
-- Exportiere Datenbank Struktur für af_test_db
CREATE DATABASE IF NOT EXISTS `af_test_db` /*!40100 DEFAULT CHARACTER SET latin1 COLLATE latin1_german1_ci */;
USE `af_test_db`;

-- Exportiere Struktur von Tabelle af_test_db.artikel
CREATE TABLE IF NOT EXISTS `artikel` (
  `Art_nr` int(11) DEFAULT NULL,
  `Art_name` text COLLATE latin1_german1_ci DEFAULT NULL,
  `Art_preis` double DEFAULT NULL,
  `Art_art` text COLLATE latin1_german1_ci DEFAULT NULL,
  `Art_reg` text COLLATE latin1_german1_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_german1_ci;

-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle af_test_db.auftrag
CREATE TABLE IF NOT EXISTS `auftrag` (
  `Auf_id` int(11) DEFAULT NULL,
  `Auf_nr` int(11) DEFAULT NULL,
  `Rechn_nr` int(11) DEFAULT NULL,
  `Menge` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_german1_ci;

-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle af_test_db.kunden
CREATE TABLE IF NOT EXISTS `kunden` (
  `Kd_nr` int(11) DEFAULT NULL,
  `Kd_name` text COLLATE latin1_german1_ci DEFAULT NULL,
  `Kd_email` text COLLATE latin1_german1_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_german1_ci;

-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle af_test_db.rechnungen
CREATE TABLE IF NOT EXISTS `rechnungen` (
  `Rechn_id` int(11) DEFAULT NULL,
  `Rechn_nr` int(11) DEFAULT NULL,
  `Kd_nr` int(11) DEFAULT NULL,
  `Rechn_Datum` date DEFAULT NULL,
  `Rechn_gpreis` double DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_german1_ci;
...
-- Exportiere Struktur von Tabelle information_schema.ALL_PLUGINS
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.APPLICABLE_ROLES
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.CHECK_CONSTRAINTS
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.CLIENT_STATISTICS
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.ENABLED_ROLES
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.GEOMETRY_COLUMNS
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INDEX_STATISTICS
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_BUFFER_PAGE
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_BUFFER_PAGE_LRU
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_BUFFER_POOL_STATS
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_CMP
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_CMPMEM
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_CMPMEM_RESET
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_CMP_PER_INDEX
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_CMP_PER_INDEX_RESET
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_CMP_RESET
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_FT_BEING_DELETED
CREATE TEMPORARY TABLE IF NOT EXISTS `INNODB_FT_BEING_DELETED` (
  `DOC_ID` bigint(21) unsigned NOT NULL DEFAULT 0
) ENGINE=MEMORY DEFAULT CHARSET=utf8;

-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_FT_CONFIG
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_FT_DEFAULT_STOPWORD
CREATE TEMPORARY TABLE IF NOT EXISTS `INNODB_FT_DEFAULT_STOPWORD` (
  `value` varchar(18) NOT NULL DEFAULT ''
) ENGINE=MEMORY DEFAULT CHARSET=utf8;

-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_FT_DELETED
CREATE TEMPORARY TABLE IF NOT EXISTS `INNODB_FT_DELETED` (
  `DOC_ID` bigint(21) unsigned NOT NULL DEFAULT 0
) ENGINE=MEMORY DEFAULT CHARSET=utf8;

-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_FT_INDEX_CACHE
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_FT_INDEX_TABLE
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_LOCKS
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_LOCK_WAITS
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_METRICS
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_MUTEXES
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_SYS_COLUMNS
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_SYS_DATAFILES
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_SYS_FIELDS
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_SYS_FOREIGN
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_SYS_FOREIGN_COLS
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_SYS_INDEXES
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_SYS_SEMAPHORE_WAITS
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_SYS_TABLES
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_SYS_TABLESPACES
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_SYS_TABLESTATS
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_SYS_VIRTUAL
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_TABLESPACES_ENCRYPTION
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_TABLESPACES_SCRUBBING
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.INNODB_TRX
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.KEY_CACHES
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.PARAMETERS
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.SPATIAL_REF_SYS
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.SYSTEM_VARIABLES
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.TABLESPACES
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.TABLE_STATISTICS
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.USER_STATISTICS
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle information_schema.user_variables
...
-- Exportiere Datenbank Struktur für performance_schema
CREATE DATABASE IF NOT EXISTS `performance_schema` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `performance_schema`;

-- Exportiere Struktur von Tabelle performance_schema.accounts
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.cond_instances
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.events_stages_current
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.events_stages_history
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.events_stages_history_long
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.events_stages_summary_by_account_by_event_name
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.events_stages_summary_by_host_by_event_name
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.events_stages_summary_by_thread_by_event_name
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.events_stages_summary_by_user_by_event_name
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.events_stages_summary_global_by_event_name
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.events_statements_current
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.events_statements_history
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.events_statements_history_long
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.events_statements_summary_by_account_by_event_name
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.events_statements_summary_by_digest
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.events_statements_summary_by_host_by_event_name
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.events_statements_summary_by_thread_by_event_name
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.events_statements_summary_by_user_by_event_name
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.events_statements_summary_global_by_event_name
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.events_waits_current
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.events_waits_history
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.events_waits_history_long
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.events_waits_summary_by_account_by_event_name
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.events_waits_summary_by_host_by_event_name
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.events_waits_summary_by_instance
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.events_waits_summary_by_thread_by_event_name
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.events_waits_summary_by_user_by_event_name
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.events_waits_summary_global_by_event_name
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.file_instances
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.file_summary_by_event_name
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.file_summary_by_instance
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.hosts
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.host_cache
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.mutex_instances
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.objects_summary_global_by_type
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.performance_timers
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.rwlock_instances
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.session_account_connect_attrs
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.session_connect_attrs
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.setup_actors
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.setup_consumers
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.setup_instruments
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.setup_objects
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.setup_timers
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.socket_instances
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.socket_summary_by_event_name
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.socket_summary_by_instance
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.table_io_waits_summary_by_index_usage
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.table_io_waits_summary_by_table
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.table_lock_waits_summary_by_table
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.threads
...
-- Daten Export vom Benutzer nicht ausgewählt
-- Exportiere Struktur von Tabelle performance_schema.users
